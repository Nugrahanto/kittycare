...
<head>
  ...
  <title>Forbidden | Kitty | We care because we love</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<h1>403</h1>
					<h2>Forbidden - Access to this resource on the server is denied!</h2>
					<a href="<?php echo base_url(); ?>" class="btn btn-main"><i class="tf-ion-android-arrow-back"></i> Go Home</a>
					<p class="copyright-text">&copy; 2018 <a href="http://www.kittycare.tk">kittycare.tk</a>
							</p>
				</div>
			</div>
		</div>
